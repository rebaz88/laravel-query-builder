...
class RequestMacrosTest extends TestCase
{
    ...
    {
        $request = new Request([
        'filterRules' => '[{"field":"foo","value":"bar"},{"field":"baz","value":"qux"}]',
        ]);
    ...
    public function is_can_get_different_filter_query_parameter_name()
    {
        ...
        $request = new Request([
        'filters' => '[{"field":"foo","value":"bar"},{"field":"baz","value":"qux,lex"}]',
        ]);
    ...
    {
        $request = new Request([
        'filterRules' => '[{"field":"foo","value":"true"},{"field":"bar","value":"false"},{"field":"baz","value":"0"}]',
        ]);
    ...
    {
        $request = new Request([
        'filterRules' => '[{"field":"foo","value":"bar,baz"}]',
        ]);
    ...
    {
        $request = new Request([
        'filterRules' => '[{"field":"foo","value":"bar,baz"},{"field":"bar","value":{"foobar":"baz,bar"}}]',
        ]);
    ...
    /** @test */
    public function does_not_process_invalid_json_format()
    {
        $this->expectException(InvalidJsonFilter::class);
        
        $request = new Request([
        'filterRules' => '[an invalid json]',
        ]);
        
        $expected = collect(["foo" => true]);
